...
from rrnco.baselines.AAFM.env_embeddings import env_init_embedding
from rrnco.baselines.AAFM.nn.attn_freenet import AttnFreeNet


class AAFMEncoder(AutoregressiveEncoder):
    ...
    def forward(
        ...
        out, distance = self.init_embedding(td, phase)
        out = self.net(out, distance)
        return out
